...
(define-test is-inside-ireland-test
  (let* ((json (jsown:parse (file-get-contents *ireland-polygon-file-path*)))
         ...
         (monaghan '(-6.96938D0 54.24657D0))
         (manorhamilton '(-8.17908D0 54.30580D0))
         (bordernearmagheraaveli '(-7.23844650000001D0 54.2073289991055D0))
         (moville '(-7.03672D0 55.18909D0))
         (backlion '(-7.87125D0 54.29091D0))
         (cork '(-8.4653D0 51.8938D0))
         (galway '(-9.04726D0 53.27090D0))
         (castletownbere '(-9.90941D0 51.64889D0))
         (armagh '(-6.65447D0 54.34985D0))
         (kilgarrowlaugh '(-7.36034D0 54.14523D0))
         (london '(-0.0882D0 51.4898D0))
         (derry '(-7.2963D0 54.9943D0))
         (overatlanticcoast '(-16.337D0 54.889D0))
         (montreal '(-73.5040D0 45.5059D0))
         (buenosaires '(-57.9749D0 -34.6083D0))
         (glasgow '(-4.2105D0 55.8627D0))
         (vilnius '(25.2801D0 54.6858D0))
         (hongkong '(114.0728D0 22.5310D0))
         (nairobi '(36.8662D0 -1.2985D0)))
     (assert-true (is-inside-or-border dublin ireland-polygon))
     (assert-true (is-inside-or-border monaghan ireland-polygon))
     (assert-true (is-inside-or-border manorhamilton ireland-polygon))
     (assert-true (is-inside-or-border bordernearmagheraaveli ireland-polygon))
     (assert-true (is-inside-or-border moville ireland-polygon))
     (assert-true (is-inside-or-border backlion ireland-polygon))
     (assert-true (is-inside-or-border cork ireland-polygon))
     (assert-true (is-inside-or-border galway ireland-polygon))
     (assert-true (is-inside-or-border castletownbere ireland-polygon))
     (assert-false (is-inside-or-border belfast ireland-polygon))
     (assert-false (is-inside-or-border armagh ireland-polygon))
     (assert-false (is-inside-or-border kilgarrowlaugh ireland-polygon))
     (assert-false (is-inside-or-border london ireland-polygon))
     (assert-false (is-inside-or-border derry ireland-polygon))
     (assert-false (is-inside-or-border overatlanticcoast ireland-polygon))
     (assert-false (is-inside-or-border montreal ireland-polygon))
     (assert-false (is-inside-or-border buenosaires ireland-polygon))
     (assert-false (is-inside-or-border glasgow ireland-polygon))
     (assert-false (is-inside-or-border vilnius ireland-polygon))
     (assert-false (is-inside-or-border hongkong ireland-polygon))
     (assert-false (is-inside-or-border nairobi ireland-polygon))))
